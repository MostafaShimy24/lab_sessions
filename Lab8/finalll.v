...
//     .VPB(VPWR),
//     .VPWR(VPWR));
//  sky130_fd_sc_hd__decap_3 PHY_EDGE_ROW_0_Left_4 (.VGND(VGND),
//     .VNB(VGND),
//     .VPB(VPWR),
//     .VPWR(VPWR));
//  sky130_fd_sc_hd__decap_3 PHY_EDGE_ROW_1_Left_5 (.VGND(VGND),
//     .VNB(VGND),
//     .VPB(VPWR),
//     .VPWR(VPWR));
//  sky130_fd_sc_hd__decap_3 PHY_EDGE_ROW_2_Left_6 (.VGND(VGND),
//     .VNB(VGND),
//     .VPB(VPWR),
//     .VPWR(VPWR));
//  sky130_fd_sc_hd__decap_3 PHY_EDGE_ROW_3_Left_7 (.VGND(VGND),
//     .VNB(VGND),
//     .VPB(VPWR),
//     .VPWR(VPWR));
