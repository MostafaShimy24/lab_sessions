...
`endif
    ...
    UUT.cycle_count = 6'b001001;
    UUT.id_ex_branch_funct3 = 3'b000;
    UUT.id_ex_conv_start = 1'b1;
    UUT.id_ex_is_branch = 1'b0;
    UUT.id_ex_is_jal = 1'b0;
    UUT.id_ex_is_jalr = 1'b0;
    UUT.id_ex_rd_addr = 5'b00100;
    UUT.id_ex_reg_write = 1'b1;
    UUT.id_ex_rs1_data = 32'b00000000000000100000000000000000;
    UUT.id_ex_rs2_data = 32'b00000000000000110000000000000000;
    UUT.seen_conv_start = 1'b1;
    UUT.seen_instr = 1'b1;
    UUT.u_ex.conv_start_i_r = 1'b0;
    UUT.u_ex.u_conv_pe.cnt_r = 4'b0011;
    UUT.u_ex.u_conv_pe.state_r = 2'b00;
    UUT.u_id.u_regfile.regs[5'b00000] = 32'b00000010000000000000000000000000;
